...
describe('Service Tests', () => {
    ...
    describe('ItemImageSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ItemImageSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/item-images';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ItemImageSuchaz', () => {

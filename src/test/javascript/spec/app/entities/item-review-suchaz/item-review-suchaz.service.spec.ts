...
describe('Service Tests', () => {
    ...
    describe('ItemReviewSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ItemReviewSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/item-reviews';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ItemReviewSuchaz', () => {

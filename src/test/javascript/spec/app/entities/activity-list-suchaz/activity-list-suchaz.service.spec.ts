...
describe('Service Tests', () => {
    ...
    describe('ActivityListSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ActivityListSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/activity-lists';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ActivityListSuchaz', () => {

...
describe('Service Tests', () => {
    ...
    describe('WishListItemSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(WishListItemSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/wish-list-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WishListItemSuchaz', () => {

...
describe('Service Tests', () => {
    ...
    describe('StoreImageSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StoreImageSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/store-images';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return StoreImageSuchaz', () => {

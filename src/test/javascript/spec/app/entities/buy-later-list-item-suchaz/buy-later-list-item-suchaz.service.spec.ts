...
describe('Service Tests', () => {
    ...
    describe('BuyLaterListItemSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BuyLaterListItemSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/buy-later-list-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BuyLaterListItemSuchaz', () => {

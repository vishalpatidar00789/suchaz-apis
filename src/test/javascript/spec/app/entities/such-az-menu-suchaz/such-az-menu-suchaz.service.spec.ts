...
describe('Service Tests', () => {
    ...
    describe('SuchAzMenuSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SuchAzMenuSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/such-az-menus';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SuchAzMenuSuchaz', () => {

...
describe('Service Tests', () => {
    ...
    describe('ActivityListItemSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ActivityListItemSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/activity-list-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ActivityListItemSuchaz', () => {

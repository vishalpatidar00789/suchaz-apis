...
describe('Service Tests', () => {
    ...
    describe('OccassionSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OccassionSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/occassions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OccassionSuchaz', () => {

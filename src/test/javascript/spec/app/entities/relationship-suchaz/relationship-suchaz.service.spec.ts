...
describe('Service Tests', () => {
    ...
    describe('RelationshipSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RelationshipSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/relationships';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RelationshipSuchaz', () => {

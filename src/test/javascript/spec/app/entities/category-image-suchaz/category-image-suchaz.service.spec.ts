...
describe('Service Tests', () => {
    ...
    describe('CategoryImageSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CategoryImageSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/category-images';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CategoryImageSuchaz', () => {

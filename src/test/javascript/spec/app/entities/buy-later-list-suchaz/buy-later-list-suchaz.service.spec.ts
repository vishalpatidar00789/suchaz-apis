...
describe('Service Tests', () => {
    ...
    describe('BuyLaterListSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BuyLaterListSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/buy-later-lists';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BuyLaterListSuchaz', () => {

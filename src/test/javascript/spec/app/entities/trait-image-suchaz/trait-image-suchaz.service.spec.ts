...
describe('Service Tests', () => {
    ...
    describe('TraitImageSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TraitImageSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/trait-images';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TraitImageSuchaz', () => {

...
describe('Service Tests', () => {
    ...
    describe('ConsumerProfileSuchaz Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConsumerProfileSuchazService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/consumer-profiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ConsumerProfileSuchaz', () => {

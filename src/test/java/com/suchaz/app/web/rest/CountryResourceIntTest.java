...
public class CountryResourceIntTest {
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getStatus()).isEqualTo(DEFAULT_STATUS);
        ...
        assertThat(testCountry.getLastUpdatedBy()).isEqualTo(DEFAULT_LAST_UPDATED_BY);
    }
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getStatus()).isEqualTo(UPDATED_STATUS);
        ...
        assertThat(testCountry.getLastUpdatedBy()).isEqualTo(UPDATED_LAST_UPDATED_BY);
    }

...
@Injectable()
export class WishListSuchazPopupService {
            ...
            if (id) {
                this.wishListService.find(id)
                    .subscribe((wishListResponse: HttpResponse<WishListSuchaz>) => {
                        const wishList: WishListSuchaz = wishListResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.wishListModalRef(component, new WishListSuchaz());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    wishListModalRef(component: Component, wishList: WishListSuchaz): NgbModalRef {

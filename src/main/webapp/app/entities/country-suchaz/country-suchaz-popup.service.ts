...
@Injectable()
export class CountrySuchazPopupService {
            ...
            if (id) {
                this.countryService.find(id)
                    .subscribe((countryResponse: HttpResponse<CountrySuchaz>) => {
                        const country: CountrySuchaz = countryResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.countryModalRef(component, new CountrySuchaz());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    countryModalRef(component: Component, country: CountrySuchaz): NgbModalRef {
